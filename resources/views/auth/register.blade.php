        ...
        <div class="auth" style="background: white;">
            <form class="from_cart_register" action="" method="post" style="width: 500px;margin:0 auto;padding: 30px 0">
                ...
                <div class="form-group">
                    ...
                    <input name="name" id="name" type="text" value="{{  old('name') }}" class="form-control" placeholder="Full Name">
                ...
                <div class="form-group">
                    ...
                    <input name="phone" id="phone" type="number" value="{{  old('phone') }}" placeholder="Phone Number" class="form-control">
